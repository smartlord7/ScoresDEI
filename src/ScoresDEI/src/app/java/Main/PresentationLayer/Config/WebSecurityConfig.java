...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers( APP_NAME + "/team/update").permitAll()
                ...
                .antMatchers( APP_NAME + "/player/update").hasAnyAuthority("ROLE_ADMIN")
                ...
                .antMatchers( APP_NAME + "/game/event/{id}").hasAnyAuthority("ROLE_ADMIN")
                .antMatchers( HttpMethod.GET, APP_NAME + "/game").permitAll()
                .antMatchers( HttpMethod.POST, APP_NAME + "/game").hasAnyAuthority("ROLE_ADMIN")
                .antMatchers( APP_NAME + "/game").permitAll()
                .antMatchers( APP_NAME + "/game/{id}/event").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
