...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, API_PREFIX + "/player/bestScorer").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
                ...
                .antMatchers(HttpMethod.GET, API_PREFIX + "/team/detailed").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
                .antMatchers(HttpMethod.GET, API_PREFIX + "/team").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
                ...
                .antMatchers(HttpMethod.GET, API_PREFIX + "/game").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
                .antMatchers(HttpMethod.GET, API_PREFIX + "/game/{id}/events").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
                .antMatchers(HttpMethod.GET, API_PREFIX + "/game/{id}").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
